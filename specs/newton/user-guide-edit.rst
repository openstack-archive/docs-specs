...
accross the OpenStack Adminstrator Guide and the OpenStack User Guide.
...
Makes specific adjustments to the Information Architecture - where content
appears in a specific chapters:
...
* Networking - Rework Networking tables for consistency. Adjust
  placement of admmonitions, and Networking Architecture information.
...
* Adapt the legacy command line client content, updating the examples to
  use the more recent OpenStack command cine client.
