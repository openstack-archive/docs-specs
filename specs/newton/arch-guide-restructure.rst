...
a more detailed structure that creates an abstraction between cloud architecture
concepts and the various Openstack projects. This will allow for easier maintenance
and updates to the guide.
