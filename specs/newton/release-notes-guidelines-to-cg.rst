...
* List links where different pieces of release notes related information
  can be found.

* Add a reference to the Contributor Guide
  at `Project Team guide <http://docs.openstack.org/project-team-guide/release-management.html#how-to-add-new-release-notes>`__.
