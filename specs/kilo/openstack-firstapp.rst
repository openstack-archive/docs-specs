...
As such, content will live in openstack-api-site like other documents
published to developer.openstack.org. Therefore the review team will be the
standard docs reviewers for this repository.
