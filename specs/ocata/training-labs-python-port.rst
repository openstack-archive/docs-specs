...
scripts to eliminate the impact of this change to the end-users. Once the python
port is tested, we will remove the host side BASH scripts. At this point the
end-users will invoke training-labs via. python. The impact to the end-users
is minimal to zero.
...
* Implement dependency handling while creating the tar/zip files.
