...
3. Restructure the guides by merging content from the Administrator User Guide
   into the Cloud Administrator Guide following information architecture. Remove
   the Administrator User Guide from openstack-manuals.
