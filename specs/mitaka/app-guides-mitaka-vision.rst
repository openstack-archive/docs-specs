...
* Landing and web pages
  ...
  * Create web pages for developer.openstack.org/sdk/python/openstacksdk - etowes
...
* Publication jobs
  ...
  * Write publishing jobs to statically copy Swagger/RST reference
    documentation from fairy-slipper to developer.openstack.org - russellsim,
    annegentle, and kbhawkey
