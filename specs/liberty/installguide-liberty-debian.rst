...
#. Based on similarity between Debian and Ubuntu we can put extra Debian parts
   with Debconf configuration and software installation to the verified Ubuntu
   guide. In such way we need to maintain only Debian specific information.
   ...
   .. note::
      ...
      will include explanations of what directives the Debian
      packages are handling automatically.

      In teh Debconf chapter we will tell users about debconf prompts with
