...
#. Convert `Install and Configure` section for each component as it refers
   to Debconf chapter providing a user with an alternative way to
   configure packages. Ubuntu way should be ok as well.
