...
#. Use ifconfig Sphinx extension http://sphinx-doc.org/ext/ifconfig.html
   to specify the conditional for Debian content using 'debian-based'
   tag according to the main specification
